...
Тестирование проводилось на Apple M4. Результаты показывают стабильную работу даже при большом количестве каналов:


| Кол-во каналов | Время выполнения (ns/op) |
|----------------|--------------------------|
| 2              | ~685 ns                  |
| 10             | ~4750 ns                 |
| 50             | ~16600 ns                |

Рекурсивный подход обеспечивает отличный баланс между читаемостью кода и производительностью для большинства задач.
